    ...
    begin
        ...
        for i in test_vector_array'range loop
            ...
            report "Test " & integer'image(i) & 
                   " Control=" & to_string(ALUControl) &
                   " ALUSrc=" & std_logic'image(ALUSrc) &
                   " RegDst=" & std_logic'image(RegDst) &
                   " ALUResult=" & to_hstring(ALUResult) &
                   " WriteReg=" & to_string(WriteReg);
