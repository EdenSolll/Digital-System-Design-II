...
HD_PWD='/home/Sol/Digital-System-Design-II/writeback/writeback.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log writeback.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source writeback.tcl -notrace
