...
HD_PWD='/home/Sol/Digital-System-Design-II/writeback/writeback.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log writeback.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source writeback.tcl
