...
{
	iki_sensitize(dp, "xsim.dir/csaTB_time_synth/xsim.reloc");
}
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 181816, dp + 182816, 0, 15, 0, 15, 16, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 181856, dp + 182928, 0, 15, 0, 15, 16, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 181896, dp + 183040, 0, 0, 0, 0, 1, 1);

}

void simulate(char *dp)
{
		iki_schedule_processes_at_time_zero(dp, "xsim.dir/csaTB_time_synth/xsim.reloc");
	wrapper_func_0(dp);
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/csaTB_time_synth/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/csaTB_time_synth/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/csaTB_time_synth/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, (void*)0, 0, isimBridge_getWdbWriter(), 0, argc, argv);
